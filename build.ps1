...
$Effects = @("ssao", "lut", "bloom", "dof", "ssil", "clarity", "outline", "kuwahara", "rtgi", "shadows", "materials", "smaa", "chromaticaberration", "deband", "filmgrain", "letterbox", "vignette", "pom", "terraintess", "subsurfacescattering")
