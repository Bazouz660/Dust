...
- **Automatic crash reports**: A preload recorder saves minidumps, logs and settings even when a save crashes before effects load. See [crash reports](docs/crash_reports.md).
