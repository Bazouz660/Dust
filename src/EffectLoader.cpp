...
static void HostSetMSAA(uint32_t sampleCount)
{
    MSAARedirect::SetEnabled(sampleCount);
}

static uint32_t HostGetMSAASampleCount()
{
...
// Implementation moved to EffectLoaderPresets.cpp.
