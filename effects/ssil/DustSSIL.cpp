...
static DustSettingDesc gSettingsArray[] = {
    { "Enabled",            DUST_SETTING_BOOL,  &gSSILConfig.enabled,          0.0f,    1.0f,   "Enabled",        nullptr, "Enable or disable screen space indirect lighting",                  DUST_PERF_HIGH },
    { "Radius",             DUST_SETTING_FLOAT, &gSSILConfig.ilRadius,         0.0005f, 0.02f,  "Radius",         nullptr, "Sampling radius for indirect light",                                DUST_PERF_NONE },
    { "Strength",           DUST_SETTING_FLOAT, &gSSILConfig.ilStrength,       0.1f,    10.0f,  "Strength",       nullptr, "Intensity of indirect lighting contribution",                       DUST_PERF_NONE },
    { "Bias",               DUST_SETTING_FLOAT, &gSSILConfig.ilBias,           0.0f,    0.3f,   "Bias",           nullptr, "Offset to prevent self-illumination artifacts",                     DUST_PERF_NONE },
    { "Max Depth",          DUST_SETTING_FLOAT, &gSSILConfig.ilMaxDepth,       0.01f,   1.0f,   "MaxDepth",       nullptr, "Maximum depth to apply the effect",                                 DUST_PERF_NONE },
    { "Foreground Fade",    DUST_SETTING_FLOAT, &gSSILConfig.foregroundFade,   1.0f,    200.0f, "ForegroundFade", nullptr, "Rate at which effect fades for very close objects",                 DUST_PERF_NONE },
    { "Falloff Power",      DUST_SETTING_FLOAT, &gSSILConfig.falloffPower,     0.5f,    5.0f,   "FalloffPower",   nullptr, "How quickly light contribution falls off with distance",            DUST_PERF_NONE },
    { "Max Screen Radius",  DUST_SETTING_FLOAT, &gSSILConfig.maxScreenRadius,  0.005f,  0.2f,   "MaxScreenRadius",nullptr, "Maximum sample radius in screen space",                             DUST_PERF_NONE },
    { "Min Screen Radius",  DUST_SETTING_FLOAT, &gSSILConfig.minScreenRadius,  0.0001f, 0.01f,  "MinScreenRadius",nullptr, "Minimum sample radius in screen space",                             DUST_PERF_NONE },
    { "Color Bleeding",     DUST_SETTING_FLOAT, &gSSILConfig.colorBleeding,    0.0f,    2.0f,   "ColorBleeding",  nullptr, "How much color from nearby surfaces bleeds onto adjacent surfaces", DUST_PERF_NONE },
