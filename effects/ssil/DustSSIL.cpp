...
static DustSettingDesc gSettingsArray[] = {
    { "Enabled",            DUST_SETTING_BOOL,  &gSSILConfig.enabled,          0.0f,    1.0f,   "Enabled",        nullptr, "Enable or disable screen space indirect lighting" },
    { "Radius",             DUST_SETTING_FLOAT, &gSSILConfig.ilRadius,         0.0005f, 0.02f,  "Radius",         nullptr, "Sampling radius for indirect light" },
    { "Strength",           DUST_SETTING_FLOAT, &gSSILConfig.ilStrength,       0.1f,    10.0f,  "Strength",       nullptr, "Intensity of indirect lighting contribution" },
    { "Bias",               DUST_SETTING_FLOAT, &gSSILConfig.ilBias,           0.0f,    0.3f,   "Bias",           nullptr, "Offset to prevent self-illumination artifacts" },
    { "Max Depth",          DUST_SETTING_FLOAT, &gSSILConfig.ilMaxDepth,       0.01f,   1.0f,   "MaxDepth",       nullptr, "Maximum depth to apply the effect" },
    { "Foreground Fade",    DUST_SETTING_FLOAT, &gSSILConfig.foregroundFade,   1.0f,    200.0f, "ForegroundFade", nullptr, "Rate at which effect fades for very close objects" },
    { "Falloff Power",      DUST_SETTING_FLOAT, &gSSILConfig.falloffPower,     0.5f,    5.0f,   "FalloffPower",   nullptr, "How quickly light contribution falls off with distance" },
    { "Max Screen Radius",  DUST_SETTING_FLOAT, &gSSILConfig.maxScreenRadius,  0.005f,  0.2f,   "MaxScreenRadius",nullptr, "Maximum sample radius in screen space" },
    { "Min Screen Radius",  DUST_SETTING_FLOAT, &gSSILConfig.minScreenRadius,  0.0001f, 0.01f,  "MinScreenRadius",nullptr, "Minimum sample radius in screen space" },
    { "Color Bleeding",     DUST_SETTING_FLOAT, &gSSILConfig.colorBleeding,    0.0f,    2.0f,   "ColorBleeding",  nullptr, "How much color from nearby surfaces bleeds onto adjacent surfaces" },
    { "Directions",         DUST_SETTING_INT,   &gSSILConfig.sampleCount,      2.0f,    12.0f,  "Directions",     nullptr, "Number of sampling directions per pixel" },
    { "Steps",              DUST_SETTING_INT,   &gSSILConfig.stepCount,        1.0f,    6.0f,   "Steps",          nullptr, "Number of samples per direction" },
    { "Blur Sharpness",     DUST_SETTING_FLOAT, &gSSILConfig.blurSharpness,    0.0f,    0.1f,   "BlurSharpness",  nullptr, "Edge-aware blur sharpness (higher = preserves more detail)" },
    { "Debug View",         DUST_SETTING_BOOL,  &gSSILConfig.debugView,        0.0f,    1.0f,   "DebugView",      nullptr, "Show raw indirect lighting before compositing" },
    // Hidden settings
