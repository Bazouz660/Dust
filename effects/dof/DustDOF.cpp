...
static DustSettingDesc gSettingsArray[] = {
    ...
    { "Focus Distance",      DUST_SETTING_FLOAT, &gDOFConfig.focusDistance,      0.001f, 0.1f,   "FocusDistance",      nullptr, "Manual focus distance (used when Auto Focus is off)",           DUST_PERF_NONE   },
    { "Near Start",          DUST_SETTING_FLOAT, &gDOFConfig.nearStart,          0.0001f, 0.05f, "NearStart",          nullptr, "Distance before focus where near blur begins",                  DUST_PERF_NONE   },
    { "Near End",            DUST_SETTING_FLOAT, &gDOFConfig.nearEnd,            0.001f,  0.1f,  "NearEnd",            nullptr, "Distance before focus where near blur reaches maximum",         DUST_PERF_NONE   },
    { "Near Strength",       DUST_SETTING_FLOAT, &gDOFConfig.nearStrength,       0.0f,    1.0f,  "NearStrength",       nullptr, "Maximum near blur intensity (0 = no near blur)",                DUST_PERF_NONE   },
    { "Far Start",           DUST_SETTING_FLOAT, &gDOFConfig.farStart,           0.0001f, 0.05f, "FarStart",           nullptr, "Distance past focus where far blur begins",                     DUST_PERF_NONE   },
    { "Far End",             DUST_SETTING_FLOAT, &gDOFConfig.farEnd,             0.001f,  0.1f,  "FarEnd",             nullptr, "Distance past focus where far blur reaches maximum",            DUST_PERF_NONE   },
    { "Far Strength",        DUST_SETTING_FLOAT, &gDOFConfig.farStrength,        0.0f,    1.0f,  "FarStrength",        nullptr, "Maximum far blur intensity (0 = no far blur)",                  DUST_PERF_NONE   },
    { "Blur Radius",         DUST_SETTING_FLOAT, &gDOFConfig.blurRadius,         1.0f,    32.0f, "BlurRadius",         nullptr, "Size of the blur kernel in pixels",                             DUST_PERF_HIGH   },
    { "Blur Downscale",      DUST_SETTING_INT,   &gDOFConfig.blurDownscale,      2.0f,    4.0f,  "BlurDownscale",      nullptr, "Resolution divisor for blur passes (2 = half, 4 = quarter)",    DUST_PERF_HIGH   },
    { "Blur Shape",          DUST_SETTING_ENUM,  &gDOFConfig.blurShape,          0.0f,    2.0f,  "BlurShape",          gBlurShapeLabels, "Blur kernel shape for out-of-focus areas",             DUST_PERF_MEDIUM },
    { "Max Depth",           DUST_SETTING_FLOAT, &gDOFConfig.maxDepth,           0.01f,   1.0f,  "MaxDepth",           nullptr, "Maximum depth to process (skip distant objects and sky)",       DUST_PERF_NONE   },
    { "Physical DoF",        DUST_SETTING_BOOL,  &gDOFConfig.physicalCoC,        0.0f,    1.0f,  "PhysicalCoC",        nullptr, "Use thin-lens aperture model instead of manual near/far ramps", DUST_PERF_NONE   },
