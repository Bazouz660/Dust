...
static DustSettingDesc gSettingsArray[] = {
    { "Enabled",            DUST_SETTING_BOOL,  &gSSAOConfig.enabled,             0.0f,    1.0f,   "Enabled",        nullptr, "Enable or disable ambient occlusion" },
    { "Radius",             DUST_SETTING_FLOAT, &gSSAOConfig.aoRadius,            0.0005f, 0.01f,  "Radius",         nullptr, "World-space sampling radius for occlusion testing" },
    { "Strength",           DUST_SETTING_FLOAT, &gSSAOConfig.aoStrength,          0.5f,    10.0f,  "Strength",       nullptr, "Intensity of the occlusion darkening" },
    { "Bias",               DUST_SETTING_FLOAT, &gSSAOConfig.aoBias,              0.0f,    0.2f,   "Bias",           nullptr, "Offset to prevent self-occlusion artifacts" },
    { "Max Depth",          DUST_SETTING_FLOAT, &gSSAOConfig.aoMaxDepth,          0.01f,   1.0f,   "MaxDepth",       nullptr, "Maximum depth to apply occlusion" },
    { "Filter Radius",      DUST_SETTING_FLOAT, &gSSAOConfig.filterRadius,        0.01f,   1.0f,   "FilterRadius",   nullptr, "Blur radius for smoothing the AO result" },
    { "Foreground Fade",    DUST_SETTING_FLOAT, &gSSAOConfig.foregroundFade,       1.0f,    200.0f, "ForegroundFade", nullptr, "Rate at which effect fades for very close objects" },
    { "Falloff Power",      DUST_SETTING_FLOAT, &gSSAOConfig.falloffPower,        0.5f,    5.0f,   "FalloffPower",   nullptr, "How quickly occlusion falls off with sample distance" },
    ...
    { "Debug View",         DUST_SETTING_BOOL,  &gSSAOConfig.debugView,           0.0f,    1.0f,   "DebugView",      nullptr, "Show raw ambient occlusion before compositing" },
