...
static DustSettingDesc gLUTSettingsArray[] = {
    { "Enabled",          DUST_SETTING_BOOL,  &gConfig.enabled,         0.0f,  1.0f,  "Enabled",         nullptr, "Enable or disable color grading",                            DUST_PERF_LOW  },
    { "Tonemapper",       DUST_SETTING_ENUM,  &gConfig.tonemapper,      0.0f,  0.0f,  "Tonemapper",      gTonemapperLabels, "HDR to LDR tonemapping operator",                  DUST_PERF_NONE },
    { "White Point",      DUST_SETTING_HIDDEN_FLOAT, &gConfig.whitePoint, 1.0f, 16.0f, "WhitePoint" },
    { "Exposure",         DUST_SETTING_FLOAT, &gConfig.exposure,        -3.0f,  3.0f,  "Exposure",        nullptr, "Overall exposure adjustment in EV stops",                    DUST_PERF_NONE },
    { "Auto Exposure",    DUST_SETTING_BOOL,  &gConfig.autoExposure,     0.0f,  1.0f,  "AutoExposure",    nullptr, "Automatically adjust exposure based on scene brightness",    DUST_PERF_LOW  },
    { "Adaptation Speed", DUST_SETTING_FLOAT, &gConfig.adaptationSpeed,  0.1f, 10.0f,  "AdaptationSpeed", nullptr, "How quickly auto-exposure adapts to brightness changes",     DUST_PERF_NONE },
    { "Min Auto EV",      DUST_SETTING_FLOAT, &gConfig.minAutoExposure, -5.0f,  0.0f,  "MinAutoExposure", nullptr, "Minimum exposure value for auto-exposure",                   DUST_PERF_NONE },
    { "Max Auto EV",      DUST_SETTING_FLOAT, &gConfig.maxAutoExposure,  0.0f,  5.0f,  "MaxAutoExposure", nullptr, "Maximum exposure value for auto-exposure",                   DUST_PERF_NONE },
    { "Intensity",        DUST_SETTING_FLOAT, &gConfig.intensity,        0.0f,  1.0f,  "Intensity",       nullptr, "Blend factor for the color grading LUT (0 = bypass)",        DUST_PERF_NONE },
    { "Lift (Shadows)",   DUST_SETTING_FLOAT, &gConfig.lift,            -0.1f,  0.1f,  "Lift",            nullptr, "Brightness offset applied to dark tones",                    DUST_PERF_NONE },
    { "Gamma (Midtones)", DUST_SETTING_FLOAT, &gConfig.gamma,            0.8f,  1.2f,  "Gamma",           nullptr, "Gamma curve adjustment for midtones",                        DUST_PERF_NONE },
    { "Gain (Highlights)",DUST_SETTING_FLOAT, &gConfig.gain,             0.8f,  1.2f,  "Gain",            nullptr, "Brightness multiplier for highlights",                       DUST_PERF_NONE },
    { "Contrast",         DUST_SETTING_FLOAT, &gConfig.contrast,         0.5f,  1.5f,  "Contrast",        nullptr, "Overall contrast adjustment",                                DUST_PERF_NONE },
    { "Saturation",       DUST_SETTING_FLOAT, &gConfig.saturation,       0.0f,  2.0f,  "Saturation",      nullptr, "Color saturation multiplier (0 = grayscale)",                DUST_PERF_NONE },
    { "Temperature",      DUST_SETTING_FLOAT, &gConfig.temperature,     -1.0f,  1.0f,  "Temperature",     nullptr, "White balance shift (negative = cooler, positive = warmer)", DUST_PERF_NONE },
    { "Tint",             DUST_SETTING_FLOAT, &gConfig.tint,            -1.0f,  1.0f,  "Tint",            nullptr, "Green-magenta tint shift",                                   DUST_PERF_NONE },
    { "Shadow Red",       DUST_SETTING_FLOAT, &gConfig.shadowR,         -0.1f,  0.1f,  "ShadowR",         nullptr, "Red tint in shadow regions",                                 DUST_PERF_NONE },
    { "Shadow Green",     DUST_SETTING_FLOAT, &gConfig.shadowG,         -0.1f,  0.1f,  "ShadowG",         nullptr, "Green tint in shadow regions",                               DUST_PERF_NONE },
    { "Shadow Blue",      DUST_SETTING_FLOAT, &gConfig.shadowB,         -0.1f,  0.1f,  "ShadowB",         nullptr, "Blue tint in shadow regions",                                DUST_PERF_NONE },
    { "Highlight Red",    DUST_SETTING_FLOAT, &gConfig.highlightR,      -0.1f,  0.1f,  "HighlightR",      nullptr, "Red tint in highlight regions",                              DUST_PERF_NONE },
    { "Highlight Green",  DUST_SETTING_FLOAT, &gConfig.highlightG,      -0.1f,  0.1f,  "HighlightG",      nullptr, "Green tint in highlight regions",                            DUST_PERF_NONE },
    { "Highlight Blue",   DUST_SETTING_FLOAT, &gConfig.highlightB,      -0.1f,  0.1f,  "HighlightB",      nullptr, "Blue tint in highlight regions",                             DUST_PERF_NONE },
};
